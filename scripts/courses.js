...
function showCourses(filteredCourses) {
    ...
    filteredCourses.forEach(courseName => {
        ...
        if (courseName.completed == true) {
            name.textContent = `✔️${courseName.subject} ${courseName.number}`;
        }
        else {
    ...
    document.getElementById('course-listed').innerHTML = `Total credits for listed courses is ${creditTotal}`;
};
